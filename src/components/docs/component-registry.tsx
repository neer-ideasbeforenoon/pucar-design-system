...
export const componentRegistry: Record<string, ComponentDoc> = {
  ...
  progress: {
    ...
    usageNotes: [
      "value is a 0–100 number; the track is bg-muted and the indicator is bg-primary.",
  ...
  skeleton: {
    ...
    tokens: ["muted"],
    usageNotes: [
      "A single bg-muted div with a pulse animation — size and shape entirely via className (rounded-full for avatars, h-3 w-3/4 for text lines).",
  ...
  slider: {
    ...
    usageNotes: [
      ...
      "Filled track and thumb use bg-primary (teal); unfilled track is bg-muted.",
    ],
  ...
  toggle: {
    ...
    usageNotes: [
      ...
      "Pressed state fills bg-muted via aria-pressed / data-state — give an icon-only Toggle an aria-label since it has no visible text.",
    ],
