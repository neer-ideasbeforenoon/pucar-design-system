...
const TEXT_PAIRS = [
  ...
  ["brand-canvas-foreground", "brand-canvas", "text on the brand canvas plate"],
  [
    "brand-canvas-muted-foreground",
    "brand-canvas",
    "support text on the brand canvas plate",
  ],
  ["paper-foreground", "paper", "ink on the court-document facsimile"],
  ["paper-muted-foreground", "paper", "muted ink on the document page"],
  ["paper-muted-foreground", "paper-muted", "muted ink on a document section band"],
